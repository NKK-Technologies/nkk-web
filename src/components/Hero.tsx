    ...
    <header id="top" className="relative bg-ice overflow-hidden">
      <div className="relative max-w-[1140px] mx-auto px-5 md:px-6 pt-14 pb-12 md:pt-24 md:pb-[104px] flex flex-col gap-5 md:grid md:grid-cols-[1.15fr_1fr] md:gap-14 md:items-center">
        <div className="flex flex-col gap-5 md:gap-6">
          <h1 className="m-0 font-display font-extrabold text-navy leading-[1.1] text-[34px] md:text-[clamp(40px,5vw,56px)]">
            The <span className="text-brand">Missing Piece</span> in Your Digital Transformation
          </h1>
          <p className="m-0 max-w-[560px] text-[17px] md:text-[19px] [text-wrap:pretty]">
        ...
        >
          ...
          >
            <g fill="rgba(255,255,255,.55)" stroke="rgba(0,136,204,.22)" strokeWidth="1.5">
              <path d="M0,0 H170 V51 A34 34 0 0 1 170 119 V170 H119 A34 34 0 0 0 51 170 H0 Z" />
              <path d="M0,170 H51 A34 34 0 0 1 119 170 H170 V221 A34 34 0 0 1 170 289 V340 H0 Z" />
              <path d="M170,170 H221 A34 34 0 0 1 289 170 H340 V340 H170 V289 A34 34 0 0 0 170 221 Z" />
            </g>
            <path
          ...
          <img
            src={iconClear}
            alt=""
            className="absolute w-[120px] h-[120px] left-1/2 ml-3 bottom-[138px] md:w-[170px] md:h-[170px] md:left-[226px] md:ml-0 md:bottom-[220px] drop-shadow-[0_14px_22px_rgba(10,25,47,.22)] md:drop-shadow-[0_18px_28px_rgba(10,25,47,.22)] animate-hero-float motion-reduce:animate-none"
          />
        </div>
      </div>
    </header>
